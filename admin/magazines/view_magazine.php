...
<div class="py-3">
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                if(isset($status)){
                    switch($status){
                        case 1:
                            echo '<span class="bg-primary badge badge-pill badge-primary">Published</span>';
                            break;
                        case 0:
                            echo '<span class="badge badge-pill badge-secondary">Not Published</span>';
                            break;
                    }
                }
                ?>
        ...
        <div class="card-footer text-center">
            <a href="./?page=magazines/manage_magazine&id=<?= isset($id) ? $id : "" ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
            <a href="./?page=magazines" class="btn btn-secondary"><i class="fa fa-angle-left"></i> Back to List</a>
        </div>
    </div>
</div>